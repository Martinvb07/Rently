...
const PATHS: Record<string, React.ReactNode> = {
  ...
  fire:    <path d="M12 2c0 4-4 6-4 10a4 4 0 0 0 8 0c0-4-4-6-4-10ZM8.5 16.5c.5-1.5 2-2.5 3.5-2.5" />,
  tv:      <><rect x="2" y="4" width="20" height="14" rx="2.5" /><path d="M8 20h8M12 18v2" /></>,
  billiard:<><circle cx="12" cy="12" r="9" /><circle cx="9" cy="11" r="1.5" fill="currentColor" stroke="none" /><circle cx="15" cy="11" r="1.5" fill="currentColor" stroke="none" /><circle cx="12" cy="15" r="1.5" fill="currentColor" stroke="none" /></>,
  hammock: <><path d="M3 8c3 0 6 3 9 3s6-3 9-3" /><path d="M6 8l-1 5m14-5 1 5M5 20h14" /></>,
  horse:   <path d="M4 17c0-3 2-5 4-7l2-2 1-4h2l1 2 2-1 1 2-3 2 1 2c2 1 3 4 3 6M8 12l-2 5M16 12l2 5" />,
  sport:   <><circle cx="12" cy="12" r="9" /><path d="M12 3c0 4.5-4 7-4 9s4 4.5 4 9M12 3c0 4.5 4 7 4 9s-4 4.5-4 9M3 12h18" /></>,
  kitchen: <><path d="M3 3v18M3 9h5M8 3v18M21 3v5a2 2 0 0 1-2 2h-4V3M19 15a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" /></>,
  gazebo:  <><path d="M3 10 12 3l9 7H3Z" /><path d="M5 10v9h14v-9M10 19v-4a2 2 0 0 1 4 0v4" /></>,
  tent:    <><path d="M3.5 21 12 4l8.5 17H3.5Z" /><path d="M12 4v17M8 21l4-6 4 6" /></>,
  trophy:  <><path d="M6 4h12v7a6 6 0 0 1-12 0V4Z" /><path d="M6 8H3a3 3 0 0 0 3 3M18 8h3a3 3 0 0 1-3 3M10 21v-4M14 21v-4M8 21h8" /></>,
  security:<><path d="M12 3.5 19 6v5.5c0 4.6-3.2 7.4-7 8.9-3.8-1.5-7-4.3-7-8.9V6l7-2.5Z" /><path d="m9 12 2 2 4-4" /></>,
  ...
  help: <><circle cx="12" cy="12" r="9" /><path d="M9.6 9.5a2.5 2.5 0 0 1 4.9.7c0 1.7-2.5 2.5-2.5 4" /><circle cx="12" cy="17.2" r="1" fill="currentColor" stroke="none" /></>,
  globe: <><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3c2.6 2.6 2.6 15.4 0 18M12 3c-2.6 2.6-2.6 15.4 0 18" /></>,
  logout: <><path d="M15 12H4m0 0 4-4m-4 4 4 4" /><path d="M10 4h7a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-7" /></>,
};
